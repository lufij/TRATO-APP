-- SOLUCIÓN DEFINITIVA PARA ERRORES 400 - VERSIÓN CORREGIDA
...
-- =============================================
-- 2. CREAR SELLER_RATINGS_VIEW (SIMPLE)
-- =============================================

DROP VIEW IF EXISTS seller_ratings_view;

-- Crear vista simple que funciona sin tabla ratings compleja
CREATE OR REPLACE VIEW seller_ratings_view AS
SELECT 
    u.id as seller_id,
    u.name as seller_name,
    'General' as business_name,           -- Valor fijo por ahora
    0.0::numeric(3,2) as average_rating,  -- Por defecto 0.0
    0::integer as total_reviews,          -- Por defecto 0
    0::integer as positive_reviews        -- Por defecto 0
FROM users u
