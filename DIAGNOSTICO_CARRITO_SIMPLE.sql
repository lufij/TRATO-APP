-- =====================================================
-- DIAGNÓSTICO SIMPLIFICADO - PROBLEMA CARRITO PRODUCTOS DEL DÍA
-- =====================================================
-- Ejecutar en SQL Editor (sin consultas problemáticas)
...
-- 6️⃣ PROBAR FUNCIÓN add_to_cart_safe (si existe)
DO $$
DECLARE
    test_result RECORD;
BEGIN
