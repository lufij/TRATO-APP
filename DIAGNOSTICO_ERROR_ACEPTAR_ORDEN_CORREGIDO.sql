-- =====================================================
-- DIAGNÓSTICO ERROR AL ACEPTAR ÓRDENES - CORREGIDO
-- =====================================================
...
-- 5. Verificar usuarios relacionados con la orden (SIN auth.users)
SELECT 
    ...
    END as relacion
FROM orders o
LEFT JOIN public.users u ON u.id IN (o.buyer_id, o.seller_id)
