-- =====================================================
-- TRATO - ACTUALIZACIÓN COMPLETA DEL SISTEMA DE ÓRDENES (VERSIÓN CORREGIDA)
-- =====================================================
...
-- VERSIÓN CORREGIDA: Arregla errores de RAISE NOTICE
...
-- =====================================================
-- 13. VERIFICACIÓN FINAL (VERSIÓN CORREGIDA)
-- =====================================================
...
BEGIN
    ...
    RAISE NOTICE '%', '==========================================';
    RAISE NOTICE '%', 'ACTUALIZACION DEL SISTEMA DE ORDENES COMPLETADA!';
    RAISE NOTICE '%', '==========================================';
    RAISE NOTICE '%', '';
    ...
    RAISE NOTICE '%', format('   • Total de tablas del sistema: %s', total_tables);
    RAISE NOTICE '%', format('   • Total de políticas de seguridad: %s', total_policies);
    ...
    IF orders_exists AND order_items_exists AND notifications_exists AND reviews_exists THEN
        ...
        RAISE NOTICE '%', '';
        RAISE NOTICE '%', 'PROXIMOS PASOS CRITICOS:';
        ...
        RAISE NOTICE '%', '';
        RAISE NOTICE '%', 'TU MARKETPLACE TRATO ESTA 100% OPERATIVO';
    ELSE
        RAISE NOTICE '%', 'Algunas tablas fallaron al crearse. Revisa los errores arriba.';
    END IF;
